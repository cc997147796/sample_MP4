...
td_s32 sample_comm_venc_save_stream_phys_addr(FILE *fd, ot_venc_stream_buf_info *stream_buf, ot_venc_stream *stream)
{
    ...
    for (i = 0; i < stream->pack_cnt; i++) {
        ...
        if (j < OT_VENC_MAX_TILE_NUM &&
            ...
            if (sample_comm_venc_phys_addr_retrace(fd, stream_buf, stream, i, j) != TD_SUCCESS) {
                return TD_FAILURE;
            }
        } else {
...
static td_void sample_comm_venc_svac3_qpmap_param_init(ot_venc_chn_attr *venc_chn_attr, td_u32 gop, td_u32 frame_rate,
    td_u32 stats_time)
{
    ot_venc_svac3_qpmap svac3_qpmap;

    venc_chn_attr->rc_attr.rc_mode = OT_VENC_RC_MODE_SVAC3_QPMAP;
    svac3_qpmap.gop = gop;
    svac3_qpmap.stats_time = stats_time;
    svac3_qpmap.src_frame_rate = frame_rate;
    svac3_qpmap.dst_frame_rate = frame_rate;
    svac3_qpmap.qpmap_mode = OT_VENC_RC_QPMAP_MODE_MEAN_QP;
...
static td_void sample_comm_venc_svac3_qvbr_param_init(ot_venc_chn_attr *venc_chn_attr, td_u32 gop, td_u32 stats_time,
    td_u32 frame_rate)
{
    ot_venc_svac3_qvbr svac3_qvbr;
    td_u32  pic_width;
    td_u32  pic_height;

    pic_width = venc_chn_attr->venc_attr.pic_width;
    pic_height = venc_chn_attr->venc_attr.pic_height;
    venc_chn_attr->rc_attr.rc_mode = OT_VENC_RC_MODE_SVAC3_QVBR;
    svac3_qvbr.gop = gop;
...
static td_void sample_comm_venc_set_h265_cvbr_bit_rate(ot_venc_chn_attr *venc_chn_attr, ot_venc_h265_cvbr *h265_cvbr,
...
static td_void sample_comm_venc_set_svac3_cvbr_bit_rate(ot_venc_chn_attr *venc_chn_attr, ot_venc_svac3_cvbr *svac3_cvbr,
    td_u32 frame_rate, ot_pic_size size)
{
    td_u32  pic_width;
    td_u32  pic_height;
...
static td_void sample_comm_venc_svac3_cvbr_param_init(ot_venc_chn_attr *venc_chn_attr, td_u32 gop, td_u32 stats_time,
    td_u32 frame_rate, ot_pic_size size)
{
    ot_venc_svac3_cvbr svac3_cvbr;

    venc_chn_attr->rc_attr.rc_mode = OT_VENC_RC_MODE_SVAC3_CVBR;
    svac3_cvbr.gop = gop;
...
static td_void sample_comm_venc_svac3_avbr_param_init(ot_venc_chn_attr *venc_chn_attr, td_u32 gop, td_u32 stats_time,
    td_u32 frame_rate)
{
    ot_venc_svac3_avbr svac3_avbr;
    td_u32  pic_width;
    td_u32  pic_height;

    pic_width = venc_chn_attr->venc_attr.pic_width;
    pic_height = venc_chn_attr->venc_attr.pic_height;
    venc_chn_attr->rc_attr.rc_mode = OT_VENC_RC_MODE_SVAC3_AVBR;
    svac3_avbr.gop = gop;
...
static td_void sample_comm_venc_svac3_vbr_param_init(ot_venc_chn_attr *venc_chn_attr, td_u32 gop, td_u32 stats_time,
    td_u32 frame_rate)
{
    ot_venc_svac3_vbr svac3_vbr;
    td_u32  pic_width;
    td_u32  pic_height;

    pic_width = venc_chn_attr->venc_attr.pic_width;
    pic_height = venc_chn_attr->venc_attr.pic_height;
    venc_chn_attr->rc_attr.rc_mode = OT_VENC_RC_MODE_SVAC3_VBR;
    svac3_vbr.gop = gop;
...
static td_void sample_comm_venc_svac3_fixqp_param_init(ot_venc_chn_attr *venc_chn_attr, td_u32 gop, td_u32 frame_rate)
{
    ot_venc_svac3_fixqp svac3_fixqp;

    venc_chn_attr->rc_attr.rc_mode = OT_VENC_RC_MODE_SVAC3_FIXQP;
    svac3_fixqp.gop = gop;
...
static td_void sample_comm_venc_svac3_cbr_param_init(ot_venc_chn_attr *venc_chn_attr, td_u32 gop, td_u32 stats_time,
    td_u32 frame_rate)
{
    ot_venc_svac3_cbr svac3_cbr;
    td_u32  pic_width;
    td_u32  pic_height;

    pic_width = venc_chn_attr->venc_attr.pic_width;
    pic_height = venc_chn_attr->venc_attr.pic_height;
    venc_chn_attr->rc_attr.rc_mode = OT_VENC_RC_MODE_SVAC3_CBR;
    svac3_cbr.gop = gop;
...
static td_void sample_comm_venc_svac3_abr_param_init(ot_venc_chn_attr *venc_chn_attr, td_u32 gop, td_u32 stats_time,
    td_u32 frame_rate)
{
    ot_venc_svac3_abr svac3_abr;
    td_u32  pic_width;
    td_u32  pic_height;

    pic_width = venc_chn_attr->venc_attr.pic_width;
    pic_height = venc_chn_attr->venc_attr.pic_height;
    venc_chn_attr->rc_attr.rc_mode = OT_VENC_RC_MODE_SVAC3_ABR;
    svac3_abr.gop = gop;
...
static td_s32 sample_comm_venc_svac3_param_init(ot_venc_chn_attr *chn_attr, sample_comm_venc_chn_param *chn_param)
{
    sample_rc rc_mode = chn_param->rc_mode;
    td_u32 gop = chn_param->gop;
    td_u32 stats_time = chn_param->stats_time;
...
static td_s32 sample_comm_venc_set_mod_type(ot_payload_type payload_type, ot_venc_mod_param *mod_param)
{
    switch (payload_type) {
        case OT_PT_H264:
        ...
        case OT_PT_JPEG:
            ...
            break;
        case OT_PT_SVAC3:
            mod_param->mod_type = OT_VENC_MOD_SVAC3;
            break;
        default:
            return TD_FAILURE;
    }
...
static td_s32 sample_comm_venc_set_mini_buf(ot_payload_type payload_type, ot_venc_mod_param *mod_param)
{
    switch (payload_type) {
        case OT_PT_H264:
...
td_s32 sample_comm_venc_mini_buf_en(sample_comm_venc_chn_param *chn_param, td_s32 venc_chn_num)
{
    td_s32 i, ret;
    ...
    for (i = 0; i < venc_chn_num; i++) {
        ...
        if (ret != TD_SUCCESS) {
            sample_print("ss_mpi_venc_get_mod_param failed with %#x!\n", ret);
            return ret;
        }
        ...
        if (ret != TD_SUCCESS) {
            sample_print("ss_mpi_venc_set_mod_param failed with %#x!\n", ret);
            return ret;
        }
    }
    ...
    td_s32 cnt, ot_size size[])
{
    ...
    g_qpmap_send_frame_para.cnt = (td_u32)cnt;
    ...
    ot_size size[], ot_venc_jpeg_roi_attr roi_attr[])
{
    ...
    g_roimap_frame_param.cnt = (td_u32)roimap_chn_info.cnt;
...
{
    td_s32 j, ret;
    td_s32 attrx[SAMPLE_VENC_NUM] = {32, 96, 128, 192, 256}; // 32 96 128 192 256 : X-coordinate
    td_s32 attry[SAMPLE_VENC_NUM] = {32, 96, 128, 192, 256}; // 32 96 128 192 256 : Y-coordinate
...
td_s32 sample_comm_venc_rateauto_start(ot_venc_chn venc_chn[], td_s32 cnt, ot_vpss_grp vpss_grp, ot_vpss_chn vpss_chn[])
{
    ...
    g_venc_rateauto_frame_param.cnt = (td_u32)cnt;
    ...
    td_s32 cnt, ot_size size[])
{
    ...
    g_send_frame_param.cnt = (td_u32)cnt;
